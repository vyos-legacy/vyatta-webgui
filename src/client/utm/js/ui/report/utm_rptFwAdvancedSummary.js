 ...
 */
/*
 Document   : utm_rptFwAdvancedSummary.js
 Created on : Mar 02, 2009, 6:18:51 PM
 Author     : Loi.Vo
 Description: summary firewall log 
 */
function UTM_rptFwAdvancedSummary(name, busLayer)
{
    var thisObjName = 'UTM_rptFwAdvancedSummary';
    this.m_id = 'rpt_fw_advanced_summary';
	...
	this.f_getPage = function()
	{
		...
		var html = "<h3>Show logs only from: LAN to WAN</h3>" +
                "<br/><br/><p>&nbsp;&nbsp;&nbsp;" +
                "This space is reserved for advanced log table." +
                "<br/>&nbsp;&nbsp;&nbsp;" +
