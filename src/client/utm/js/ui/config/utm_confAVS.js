/*
 Document   : utm_confAVS.js
 Created on : Mar 02, 2009, 6:18:51 PM
 Author     : Loi.Vo
 Description: URL filtering expert
 */
function UTM_confAVS(name, callback, busLayer)
{
	var thisObjName = 'UTM_confAVS';
	var thisObj = this;
    ...
    {
        var btSubcribe = document.getElementById('conf_avs_subscribe');
    ...
    this.f_handleClick = function(e)
    {
        ...
        if (target != undefined) {
            ...
            if (id == 'conf_avs_subscribe') { //subscribe clicked
				thisObj.f_subscribe();
				return false;
			}
        }
