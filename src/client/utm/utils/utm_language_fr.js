...
var g_lang =
{
    ...
    m_dbActivated: "activée",
    m_dbDeactivated: "Désactivé",
    ...
    m_resetError : "réinitialisation d'erreur",
    ...
    m_vpnDeleteConfirm  : "etes-vous sûr de vouloir supprimer",
    ...
    m_fireLevelBdDef : "tout le trafic est bloqué",	
    m_fireLevelHdAuth : "faible", 
    m_fireLevelBdAuth : "fonctionnalités de pare-feu est désactivé. Tout le trafic est autorisé.", 
    m_fireLevelHdStand : "moyen", 
    m_fireLevelBdStand : "permet à tous les services, sauf Netbios (ports 135, 137, 138, 139 and 445).",
    ...
    m_fireLevelBdBlock : "bloque tout le trafic de données. Seul le trafic voix est autorisée", 
    ...
    m_fireCustInternIpAddr : "internes IP<br>Adresse<small><br>célibataire IP or an IP<br>range</small>", 
