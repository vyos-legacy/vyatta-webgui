...
function UTM_2ndNavigation(){
    ...
    this.f_init = function(p){
        ...
        thisObj.m_parent = p;
        thisObj.m_menu = g_utmRoleObj.f_getMenu();
        thisObj.m_parent_container = document.getElementById(VYA.UTM_CONST.DOM_MAIN_PANEL_OA_CONTAINER_ID); //'oa_container'
        		
        var menu = document.getElementById(VYA.UTM_CONST.DOM_MAIN_PANEL_2_NAV_UL_ID); //'oa_2_nav'
	...
	this.f_highlightItem = function(id) {
        ...
        var menu = document.getElementById(VYA.UTM_CONST.DOM_MAIN_PANEL_2_NAV_UL_ID);
        for (var i = 0; menu.childNodes[i]; i++) {
