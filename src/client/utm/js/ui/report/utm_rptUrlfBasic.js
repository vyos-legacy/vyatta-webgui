 ...
 */
/*
 Document   : utm_rptUrlfBasic.js
 Created on : Mar 02, 2009, 6:18:51 PM
 Author     : Loi.Vo
 Description: basic web filtering log class
 */
function UTM_rptUrlfBasic(name, busLayer, refresh)
{
    var thisObjName = 'UTM_rptUrlfBasic';
    var thisObj = this;
	...
	{
		var c = new UTM_rptUrlfBasicSummary('FT_rptUrlfBasicSummary', thisObj.m_busLayer);
