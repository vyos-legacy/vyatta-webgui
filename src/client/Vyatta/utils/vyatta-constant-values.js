...
V_DIRTY_FLAG = '<img title="node has been modified" src="images/statusUnknown.gif" />';
V_DIRTY_FLAG_DEL = '<img title="node has been deleted" src="images/statusMinus.gif" />';
V_DIRTY_FLAG_ADD = '<img title="node has been created" src="images/statusPlus.gif" />';
V_EMPTY_FLAG = '<img src="images/empty.gif" width="13"/>';
V_HIDE_DIRTY_FLAG = '<img src="images/empty.gif" />';
V_ERROR_FLAG = '<img title="error node" src="images/statusDown.gif" />'
