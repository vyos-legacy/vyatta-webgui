...
#ifndef __INCLUDE_SERVER_TIME_INFO_HH__
#define __INCLUDE_SERVER_TIME_INFO_HH__

#include "common/time_info.hh"

class ServerTimeInfo : public TimeInfo {
public:
	ServerTimeInfo();

	void determineGMTime();
	void determineLocalTime();
