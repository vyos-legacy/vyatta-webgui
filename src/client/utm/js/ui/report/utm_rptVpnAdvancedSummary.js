 ...
 */
/*
 Document   : utm_rptVpnAdvancedSummary.js
 Created on : Mar 02, 2009, 6:18:51 PM
 Author     : Loi.Vo
 Description: summary advanced vpn log 
 */
function UTM_rptVpnAdvancedSummary(name, busLayer)
{
    var thisObjName = 'UTM_rptVpnAdvancedSummary';
    this.m_id = 'rpt_vpn_advanced_summary';
	...
	this.f_getPage = function()
	{
		...
		var html = "<h3>Show advanced VPN log table</h3>" +
                "<br/><br/><p>&nbsp;&nbsp;&nbsp;" +
                "This space is reserved for advanced VPN log table." +
                "<br/>&nbsp;&nbsp;&nbsp;" +
